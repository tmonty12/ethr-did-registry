...
const LOCALHOST_DELGATE_VALIDITY = 86400 // 1 day in seconds
...
const GOERLI_DELEGATE_TYPE = ethers.utils.formatBytes32String("veriKey")
const GOERLI_DELGATE_VALIDITY = 86400 // 1 day in seconds
...
async function main() {
  ...
  await contractInstance.addDelegate(GOERLI_IDENTITY, 
    GOERLI_DELEGATE_TYPE, 
    GOERLI_IDENTITY_DELEGATE, 
    GOERLI_DELGATE_VALIDITY)
  console.log('Identity ' + GOERLI_IDENTITY + 'has assigned a delegate ' + GOERLI_IDENTITY_DELEGATE)
}
